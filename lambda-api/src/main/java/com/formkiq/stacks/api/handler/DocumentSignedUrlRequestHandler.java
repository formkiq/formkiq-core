...
/** {@link RequestHandler} for GET "/documents/upload" and "/documents/{documentId}/upload". */
public class DocumentSignedUrlRequestHandler implements RequestHandler {
   ...
   * @param maxContentLength {@link DocumentsRestrictionsMaxContentLength}
   */
  public DocumentSignedUrlRequestHandler(final DocumentsRestrictionsMaxDocuments maxDocuments,
      final DocumentsRestrictionsMaxContentLength maxContentLength) {
    this.restrictionMaxDocuments = maxDocuments;
    this.restrictionMaxContentLength = maxContentLength;
  }
